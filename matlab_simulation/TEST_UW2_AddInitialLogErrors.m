%Abstract:
%This file tests our UW2_AddInitialLogErrors function.
%Run the test by executing:
%   results = runtests('TEST_UW2_AddInitialLogErrors.m');
...
[qd, pd] = UW2_AddInitialLogErrors(qd0, pd0, SampledZero);
...
[qd, pd] = UW2_AddInitialLogErrors(qd0, pd0, SampledOne);
