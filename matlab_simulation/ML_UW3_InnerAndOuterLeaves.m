function [Zerr,Xerr] = ML_UW3_InnerAndOuterLeaves(L0, sigGKP, etas, etam, etad, etac, Lcavity, k, v, leaves, N)
...
[Zerr, Xerr] = ML_UW3_InnerAndOuterLeaves(9, 0.12, 0.995, 0.999995, 0.9975, 0.99, 2, 15, 0.3, 0, 10000000)
...
%When leaves ~= 2, we simulate Outer-Leaves Swapping using the UW2_OuterLeaves function. In this case, we record the average over N trials.
    ...
    parfor i = 1:N
        logErrOuter = ML_UW3_OuterLeaves(L0, sigGKP, etas, etad, etac, k, ErrProbVec);
