%Abstract:
%This file tests our LP_InnerAndOuterLeaves-function.
%Please try "results = runtests('TEST_LP_InnerAndOuterLeaves.m')"
...
[Zerr2,Xerr2] = LP_InnerAndOuterLeaves(L, sigGKP2, etas, etam, etad, etac, Lcavity, k, v, leaves, N);
