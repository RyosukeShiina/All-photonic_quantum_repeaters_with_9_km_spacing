%Abstract:
%This file tests our LP_AddInitialLogErrorsInnerLeaves function.
%Run the test by executing:
%   results = runtests('TEST_LP_AddInitialLogErrorsInnerLeaves.m');
...
[qd, pd] = LP_AddInitialLogErrorsInnerLeaves(qd0, pd0, SampledZero);
...
[qd, pd] = LP_AddInitialLogErrorsInnerLeaves(qd0, pd0, SampledOne);
