...
%Please try "results = runtests('TEST_UW2_OuterLeaves.m')"
...
L1 = 9;
L2 = 20;
logErr1 = UW2_OuterLeaves(L1, sigGKP, etas, etad, etac, k, ErrProbVec);
logErr2 = UW2_OuterLeaves(L2, sigGKP, etas, etad, etac, k, ErrProbVec);
