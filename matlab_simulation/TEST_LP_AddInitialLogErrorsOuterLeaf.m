%Abstract:
%This file tests our LP_AddInitialLogErrorsOuterLeaf function.
%Run the test by executing:
%   results = runtests('TEST_LP_AddInitialLogErrorsOuterLeaf.m');
...
[qd, pd] = LP_AddInitialLogErrorsOuterLeaf(qd0, pd0, SampledZero);
...
[qd, pd] = LP_AddInitialLogErrorsOuterLeaf(qd0, pd0, SampledOne);
