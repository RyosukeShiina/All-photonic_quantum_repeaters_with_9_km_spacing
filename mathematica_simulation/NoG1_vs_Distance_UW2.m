...
Print["*****************1**********************"]
G1List = Range[401, 1001];
three9data[[1]] = Join @@ ParallelTable[FindRequiredNoG1[0.999, i, req[[1]]], {i, start, end, step}]
df = List @@ three9data[[1]]
Export["/home/rshiina_umass_edu/NoG1_vs_Distance_UW2/NoG1_three9_vs_Distance_UW2_5.csv", Transpose@{df}, "CSV"]

Print["*****************2**********************"]
G1List = Range[401, 1001];
four9data[[1]] = Join @@ ParallelTable[FindRequiredNoG1[0.9999, i, req[[1]]], {i, start, end, step}]
df = List @@ four9data[[1]]
Export["/home/rshiina_umass_edu/NoG1_vs_Distance_UW2/NoG1_four9_vs_Distance_UW2_5.csv", Transpose@{df}, "CSV"]

Print["*****************3**********************"]
G1List = Range[701, 1501];
three9data[[2]] = Join @@ ParallelTable[FindRequiredNoG1[0.999, i, req[[2]]], {i, start, end, step}]
df = List @@ three9data[[2]]
Export["/home/rshiina_umass_edu/NoG1_vs_Distance_UW2/NoG1_three9_vs_Distance_UW2_10.csv", Transpose@{df}, "CSV"]

Print["*****************4**********************"]
G1List = Range[801, 1501];
four9data[[2]] = Join @@ ParallelTable[FindRequiredNoG1[0.9999, i, req[[2]]], {i, start, end, step}]
df = List @@ four9data[[2]]
Export["/home/rshiina_umass_edu/NoG1_vs_Distance_UW2/NoG1_four9_vs_Distance_UW2_10.csv", Transpose@{df}, "CSV"]
