...
Print["**********************************k=5**********************************"]
G1List = Range[601, 751];(*Range of Binary Search*)
...
dir = FileNameJoin[{"/home/rshiina_umass_edu/NoG1_vs_k_UW2", "NoG1_three9_vs_k_UW2_to5"}];
If[! DirectoryQ[dir], CreateDirectory[dir]];
Do[col = Transpose[three9Alldata][[i]];
 Print["L_total = ", 45*i, ": ", col];
 Export[FileNameJoin[{dir, "NoG1_three9_vs_k_UW2_" <> ToString[45*i] <> "km.csv"}], col], {i, Length[First[three9Alldata]]}]

dir = FileNameJoin[{"/home/rshiina_umass_edu/NoG1_vs_k_UW2", "NoG1_four9_vs_k_UW2_to5"}];
If[! DirectoryQ[dir], CreateDirectory[dir]];
Do[col = Transpose[four9Alldata][[i]];
 Print["L_total = ", 45*i, ": ", col];
 Export[FileNameJoin[{dir, "NoG1_four9_vs_k_UW2_" <> ToString[45*i] <> "km.csv"}], col], {i, Length[First[four9Alldata]]}]

Print["**********************************k=6**********************************"]
G1List = Range[701, 901];
...
dir = FileNameJoin[{"/home/rshiina_umass_edu/NoG1_vs_k_UW2", "NoG1_three9_vs_k_UW2_to10"}];
If[! DirectoryQ[dir], CreateDirectory[dir]];
Do[col = Transpose[three9Alldata][[i]];
 Print["L_total = ", 45*i, ": ", col];
 Export[FileNameJoin[{dir, "NoG1_three9_vs_k_UW2_" <> ToString[45*i] <> "km.csv"}], col], {i, Length[First[three9Alldata]]}]

dir = FileNameJoin[{"/home/rshiina_umass_edu/NoG1_vs_k_UW2", "NoG1_four9_vs_k_UW2_to10"}];
If[! DirectoryQ[dir], CreateDirectory[dir]];
Do[col = Transpose[four9Alldata][[i]];
 Print["L_total = ", 45*i, ": ", col];
 Export[FileNameJoin[{dir, "NoG1_four9_vs_k_UW2_" <> ToString[45*i] <> "km.csv"}], col], {i, Length[First[four9Alldata]]}]
...
dir = FileNameJoin[{"/home/rshiina_umass_edu/NoG1_vs_k_UW2", "NoG1_three9_vs_k_UW2_to13"}];
If[! DirectoryQ[dir], CreateDirectory[dir]];
Do[col = Transpose[three9Alldata][[i]];
 Print["L_total = ", 45*i, ": ", col];
 Export[FileNameJoin[{dir, "NoG1_three9_vs_k_UW2_" <> ToString[45*i] <> "km.csv"}], col], {i, Length[First[three9Alldata]]}]

dir = FileNameJoin[{"/home/rshiina_umass_edu/NoG1_vs_k_UW2", "NoG1_four9_vs_k_UW2_to13"}];
If[! DirectoryQ[dir], CreateDirectory[dir]];
Do[col = Transpose[four9Alldata][[i]];
 Print["L_total = ", 45*i, ": ", col];
 Export[FileNameJoin[{dir, "NoG1_four9_vs_k_UW2_" <> ToString[45*i] <> "km.csv"}], col], {i, Length[First[four9Alldata]]}]
